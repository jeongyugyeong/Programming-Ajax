...
var hotel = {
    ...
    discount: 15, // 할인율 (%)
    offerPrice: function() {
        var offerPrice = this.roomRate * ((100 - this.discount) / 100);
        return offerRate;
    }
}
...
hotelName.textContent = hotel.name; // 호텔이름출력
roomRate.textContent = '$' + hotel.roomRate; // 방가격출력
specialRate.textContent = '$' + hotel.offerPrice().toFixed(0); //할인된가격출력

//두 번째 부분 : 할인 행사 상세 정보를 계산하여 출력한다.
var expiryMsg; //사용자에게 보여질 메세지
var today; //오늘 날짜
